        ...
        <div class="col-6">
            ...
            <form action="/member/modify" method="post" onsubmit="return confirm('저장하시겠습니까?')">
                ...
                <div class="mb-4">
                    ...
                    <input oninput="passwordCheck()" id="inputPasswordCheck" type="password" value="${member.password}"
                           class="form-control">
                ...
                <div class="mb-4">
                    ...
                    <input name="nickName" id="inputNickName" type="text" value="${member.nickName}"
                           class="form-control">
                </div>
                <div class="mb-3">
